...
import { randomNum, calculateWidth } from '../../utils/utils.js'
import { withRouter } from 'react-router-dom'
import { Form, Input, Row, Col } from 'antd'
import PromptBox from '../../component/PromptBox'
import {ajaxLogin} from '../common/action'
...
class LoginForm extends React.Component {
    ...
    createCode = () => {
        ...
        this.props.form.validateFields((err, values) => {
            ...
            this.props.ajaxLogin(values,this.props.form.setFields)
...
export default withRouter(Form.create({})(connect(mapStateToProps,mapDispatchProps)(LoginForm)))